...
Gender = st.slider("Gender", min_value=0, max_value=1, value=20)
Income_Medium = st.slider("Income_Medium", min_value=0, max_value=1000, value=20)
Marital_Status_Widowed = st.slider("Marital_Widowed", min_value=0, max_value=1, value=20)
Marital_Status_Divorced = st.slider("Marital_Divorced", min_value=0, max_value=1, value=20)
